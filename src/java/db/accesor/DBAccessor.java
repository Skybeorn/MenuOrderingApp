...
public interface DBAccessor {
	...
	/**
	 * Can be used to perform sql queries by date range on a single table. 
	 * No other criteria are supported. Implementations should carefully handle
	 * date criteria in the sql syntax specified by the database vendor.
	 * 
	 ...
	 * @throws Exception for all other problems
	 */
	public abstract List findRecordsByDateRange(String[] returnfields, String tableName, String dateField,
